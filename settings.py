...
class Settings:
    def __init__(self, waste_size=3, deck_passes_allowed=1000, card_back=f"card_back0.png"):
...
class SettingsDialog(ft.AlertDialog):
    ...
    def generate_card_backs(self):
        self.card_backs = []
        for i in range(4):
            self.card_backs.append(ft.Container(width=70, height=100, content=ft.Image(src=f"card_back{i}.png"), border_radius=ft.border_radius.all(6), on_click=self.choose_card_design, data=i))
